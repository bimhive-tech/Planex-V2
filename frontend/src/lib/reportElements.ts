...
export const CHART_TEXT_KEYS: Record<string, string[]> = {
  ...
  project_duration: ["duration_days", "duration_elapsed", "duration_remaining"],
...
export const TABLE_SOURCES = [
  ...
  { value: "discipline_progress", label: "Progress by phase" },
...
export const CHART_SOURCES = [
  ...
  { value: "project_duration", label: "Duration in working days (dashboard pie)" },
