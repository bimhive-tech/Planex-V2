...
export const BUILDER_SECTIONS: BuilderSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: "labels.info_code", label: "Row: Project code", type: "text" },
      ...
      { path: "labels.info_contract_value", label: "Row: Contract value", type: "text" },
      { path: "labels.info_approved_value", label: "Row: Approved value", type: "text" },
      { path: "labels.info_forecast_cost", label: "Row: Forecast cost", type: "text" },
      { path: "labels.info_duration", label: "Row: Contract duration", type: "text" },
      { path: "labels.info_start", label: "Row: Start", type: "text" },
      { path: "labels.info_finish", label: "Row: Finish", type: "text" },
      { path: "labels.info_revised", label: "Row: Revised finish", type: "text" },
      { path: "labels.info_forecast", label: "Row: Forecast finish", type: "text" },
      { path: "labels.info_delay", label: "Row: Delay (days)", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: "labels.progress_report", label: "Progress Report heading", type: "text" },
      { path: "sections.progress_chart", label: "Show planned/actual chart (by zone)", type: "toggle" },
      { path: "sections.area_progress_chart", label: "Show planned/actual chart (by area)", type: "toggle" },
      { path: "labels.area_progress_chart", label: "Area chart heading", type: "text" },
      ...
      { path: "labels.hierarchy_progress", label: "Breakdown table heading", type: "text" },
      { path: "labels.discipline_progress", label: "Trade table heading", type: "text" },
      ...
      { path: "colors.gauge_excellent", label: "SPI gauge: Excellent", type: "color" },
      { path: "gauge_thresholds.low", label: "SPI gauge: Average threshold (%)", type: "number" },
      { path: "gauge_thresholds.mid", label: "SPI gauge: Good threshold (%)", type: "number" },
      { path: "gauge_thresholds.high", label: "SPI gauge: Excellent threshold (%)", type: "number" },
    ],
  },
  {
    title: "Finances",
    key: "finances",
    hint: "Cash flow (monthly planned vs actual) and invoices — entered on the project's Finances tab.",
    fields: [
      { path: "sections.cashflow", label: "Show cash flow charts", type: "toggle" },
      { path: "labels.cashflow", label: "Cash flow heading", type: "text" },
      { path: "labels.cashflow_monthly", label: "Monthly chart caption", type: "text" },
      { path: "labels.cashflow_cumulative", label: "Cumulative chart caption", type: "text" },
      { path: "sections.invoices", label: "Show invoices table", type: "toggle" },
      { path: "labels.invoices", label: "Invoices heading", type: "text" },
      { path: "labels.col_invoice", label: "Column: Item / reason", type: "text" },
      { path: "labels.col_value", label: "Column: Value", type: "text" },
      { path: "labels.col_total", label: 'Word: "Total"', type: "text" },
    ],
  },
  {
    title: "Submittals",
    key: "submittals",
    enablePath: "sections.submittals",
    hint: "Shop drawings & material submittals and their approval status — managed on the project's Submittals tab.",
    fields: [
      { path: "labels.submittals", label: "Section heading", type: "text" },
      { path: "labels.submittal_summary", label: "Status-summary heading", type: "text" },
      { path: "labels.col_type", label: "Column: Type", type: "text" },
      { path: "labels.col_discipline", label: "Column: Discipline", type: "text" },
      { path: "labels.col_status", label: "Column: Status", type: "text" },
      { path: "labels.col_count", label: "Column: Count", type: "text" },
    ],
  },
  {
