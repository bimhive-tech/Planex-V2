...
from .structure_views import (
    ...
    ScheduleImportFileView,
    ScheduleImportDetailView,
    ScheduleImportListView,
    ScopeTreeView,
    ProjectZoneGridView,
    ScopeActivitiesView,
    ScopeDetailView,
...
urlpatterns = [
    ...
    path("projects/<uuid:project_id>/schedule-imports/", ScheduleImportListView.as_view(), name="project-schedule-imports"),
    path("projects/<uuid:project_id>/schedule-imports/<uuid:import_id>/",
         ScheduleImportDetailView.as_view(), name="project-schedule-import-detail"),
    path("projects/<uuid:project_id>/schedule-imports/<uuid:import_id>/file/",
         ScheduleImportFileView.as_view(), name="project-schedule-import-file"),
